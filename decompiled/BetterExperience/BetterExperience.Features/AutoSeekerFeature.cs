...
public static class AutoSeekTuning
{
	...
	/// <summary>
	/// 1.0 for release. 4x was a DEVELOPMENT default — deliberately aggressive, because a
	/// placement loop that converges at 4x has real stability margin and one that only converges
	/// slowly is sitting on the edge. That reasoning is for finding the limit, not for shipping
	/// at it: the slider still reaches 8x for anyone who wants it.
	/// </summary>
